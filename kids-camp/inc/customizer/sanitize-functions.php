<?php
/**
 * Kids Camp Theme Options Sanitization Functions
 *
 * @package Kids_Camp
 */
 ...
 */
function kids_camp_sanitize_select( $input, $setting ) {
 ...
 */
function kids_camp_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function kids_camp_sanitize_post( $input ) {
 ...
 */
function kids_camp_sanitize_image( $image, $setting ) {
    /*
 ...
 * @since Kids Camp 1.0
 */
function kids_camp_sanitize_category_list( $input ) {
 ...
 *                    the setting default.
 */
function kids_camp_sanitize_number_range( $number, $setting ) {
 ...
 * @return string
 */
function kids_camp_sanitize_date_time( $input ) {
